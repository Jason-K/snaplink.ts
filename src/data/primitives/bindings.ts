...
export type Trigger =
  ...
  | { keys: TriggerKey[]; modifiers?: TriggerModifiers; order?: SimOrder; chordTiming?: BindingTiming }
...
export type Binding = {
  ...
  /**
   * Set `detect_key_down_uninterruptedly` for simultaneous chords.
   */
  ...
  /**
   * Set simultaneous chord threshold in milliseconds (`basic.simultaneous_threshold_milliseconds`).
   */
