...
export const APPS = {
  ...
  keSettings: app("org.pqrs.Karabiner-Elements.Settings", "Karabiner Settings"),
  keEvents: app("org.pqrs.Karabiner-EventViewer", "Karabiner EventViewer"),
  ...
  msWord: app("com.microsoft.Word", "Microsoft Word"),
  msExcel: app("com.microsoft.Excel", "Microsoft Excel"),
  msOutlook: app("com.microsoft.Outlook", "Microsoft Outlook"),
  ...
  settingsUpdates: app("com.apple.Software-Update-Settings.extension", "System Settings, updates"),
