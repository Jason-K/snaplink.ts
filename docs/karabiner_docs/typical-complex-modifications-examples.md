  ...
  "manipulators": [
    {
      ...
      "to": [{ "apple_vendor_keyboard_key_code": "mission_control" }, { "key_code": "vk_none" }],
      "conditions": [
        {
          "type": "expression_if",
  ...
  "manipulators": [
    {
      ...
      "to": [{ "set_variable": { "name": "q pressed", "value": false } }, { "key_code": "escape" }],
  ...
  "manipulators": [
    {
      "type": "basic",
      "from": {
        "simultaneous": [{ "key_code": "equal_sign" }, { "key_code": "delete_or_backspace" }],
        "modifiers": { "optional": ["any"] }
      },
