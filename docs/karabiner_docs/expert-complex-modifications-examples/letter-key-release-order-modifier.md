    ...
    manipulators.push({
      ...
      from: {
        ...
        simultaneous_options: {
          ...
          to_after_key_up: [{ set_variable: { name: "v_flag", value: false } }],
        },
        modifiers: { optional: ["any"] },
      },
      to: [{ set_variable: { name: "v_flag", value: true } }, { key_code: def.to }],
      parameters: {
...
```json
{
  ...
  "manipulators": [
    ...
    },
    {
      ...
      "to": [{ "set_variable": { "name": "v_flag", "value": true } }, { "key_code": "down_arrow" }],
      "parameters": {
        "basic.simultaneous_threshold_milliseconds": 500
      }
    },
    ...
    },
    {
      ...
      "to": [{ "set_variable": { "name": "v_flag", "value": true } }, { "key_code": "up_arrow" }],
      "parameters": {
        "basic.simultaneous_threshold_milliseconds": 500
      }
    }
