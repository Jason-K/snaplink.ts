...
| `left_alt`      | Alias of `left_option`                          | Karabiner-Elements 12.3.0 |
| `left_gui`      | Alias of `left_command`                         | Karabiner-Elements 12.3.0 |
| `right_alt`     | Alias of `right_option`                         | Karabiner-Elements 12.3.0 |
| `right_gui`     | Alias of `right_command`                        | Karabiner-Elements 12.3.0 |
| `any`           | Any modifiers                                   |                           |
