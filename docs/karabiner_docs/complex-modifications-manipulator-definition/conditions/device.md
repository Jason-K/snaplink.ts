...
| Name                   | Required | Description                                                                                     | Fixed Value | Available since            |
| :--------------------- | :------- | :---------------------------------------------------------------------------------------------- | :---------- | :------------------------- |
| `vendor_id`            | Optional | Vendor ID of device                                                                             | Yes         |                            |
| `product_id`           | Optional | Product ID of device                                                                            | Yes         |                            |
| `device_address`       | Optional | Bluetooth address (Bluetooth MAC address) of device<br />(only available for Bluetooth devices) | Yes `[1]`   | Karabiner-Elements 14.12.2 |
...
| `is_game_pad`          | Optional | `true` or `false`                                                                               | Yes         | Karabiner-Elements 14.12.4 |
| `is_consumer`          | Optional | `true` or `false`                                                                               | Yes         | Karabiner-Elements 15.3.18 |
| `is_touch_bar`         | Optional | `true` or `false`                                                                               | Yes         |                            |
| `is_built_in_keyboard` | Optional | `true` or `false`                                                                               | Yes         | Karabiner-Elements 14.8.2  |
